...
var contactLinks = [
  {
    link: "mailto:carl@computercarl.com",
    label: "carl@computercarl.com",
    icon: Email,
  },
  ...
  {
    link: "https://github.com/ComputerCarl",
    label: "ComputerCarl",
    icon: Github,
  },
  { link: "https://computercarl.com", label: "ComputerCarl.com", icon: Link },
  {
    link: "https://computercarl.com/carl-mann-technology-generalist-resume.pdf",
    label: "résumé",
    icon: Attachment,
  },
]
        ...
        <Styled>
          ...
          <Responsive>
            ...
            <div>
              <img
                src={svgCactus}
                alt="computer screen with a wee baby cactus"
              />
            </div>
          </Responsive>
        </Styled>
